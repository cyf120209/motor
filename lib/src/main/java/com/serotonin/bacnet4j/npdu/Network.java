...
abstract public class Network {
    ...
    public boolean enableRouter=false;
    private Transport transport;
    public Network peerNet;
    ...
    abstract public void sendNPDU(final Address recipient,NPDU npdu);
    abstract public void checkSendThread();

    abstract public void SendIamRouter(List<Integer> list);
    ...
    public boolean isLocal(Address recipient) {
